...
<form action="" method="POST">
    ...
    <textarea name="text" rows="5" cols="80"><?php echo isset($update_news['full_description'])?$update_news['full_description']:'Введите сюда полный текст новости'; ?></textarea><br />
